...
//	}
//
// Enrich the order info to add area
func enrich(_ context.Context, keys []string, d mapper.Datum) mapper.Messages {
...
// Count how many data comes for a particular keys combination
func aggregate(_ context.Context, keys []string, inputCh <-chan reducer.Datum, md reducer.Metadata) reducer.Messages {
